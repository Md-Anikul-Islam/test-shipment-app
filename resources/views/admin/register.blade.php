                ...
                <div class="card overflow-hidden">
                    <div class="row g-0 align-items-center">
                        <div class="col-lg-6 d-none d-lg-block p-2">
                            <img src="{{ asset('backend/images/cute-courier-delivery-packages-with-van-cartoon-vector.jpg') }}" alt="" class="img-fluid rounded h-200">
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="p-4 pt-0 my-auto">
                                    ...
                                    <form method="POST" action="{{ route('user.store') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="name" id="emailaddress" name="name" value="{{ old('name') }}" required placeholder="Enter your name">
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="mb-0 text-start">
                                        <a href="{{route('login')}}" class="btn btn-soft-warning w-100">Already have Account?</a>
                                    </div>
                                </div>
