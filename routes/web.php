...
Route::get('/user-register', [AdminDashboardController::class, 'register'])->name('user.register');
Route::post('/user-store', [AdminDashboardController::class, 'storeRegister'])->name('user.store');
